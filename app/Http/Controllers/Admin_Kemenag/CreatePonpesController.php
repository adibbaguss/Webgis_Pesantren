...
class CreatePonpesController extends Controller
{
    ...
    protected function create(Request $request)
    {
        ...
        return Redirect::route('admin_kemenag_kemenag.data_ponpes')->with('success', 'Berhasil Menambahkan ' . $namePonpes);
    ...
    //     return view('admin_kemenag_kemenag.create_ponpes_2', compact('ponpes'));
    // }
