...
class DataStatistikController extends Controller
{
    public function index()
    {
        ...
        return view('admin_kemenag.data_statistik', compact('ponpes', 'ChartDataPonpes', 'ChartDataJumlahPonpes', 'ChartDataStudent', 'ChartDataMadin', 'ChartDataJumlahMadin', 'ChartDataStudentMadin'));
    }
