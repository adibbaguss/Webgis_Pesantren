...
class UpdatePonpesController extends Controller
{
    public function index($id)
    {
        ...
        return view('admin_kemenag.update_ponpes', compact('ponpes', 'kecamatanOptions', 'user'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin_kemenag.ponpes_view', ['id' => $id])->with('success', 'Pondok Pesantren updated successfully!');
    }
}
