...
class MapFacilityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelapor.map_facility', compact('ponpes', 'facilities', 'attributeNames', 'attributeTable'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $attributeTable = $this->attributeTable;
        $ponpes = Ponpes::with('facility')->get();
        return view('pelapor.map_facility', compact('ponpes', 'facilities', 'attribute', 'attributeNames', 'attributeTable'));
