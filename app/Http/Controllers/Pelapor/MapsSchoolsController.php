...
class MapsSchoolsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelapor.map_school', compact('ponpes', 'attributeNames', 'attributeTable', 'counts', 'schools'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $attributeNames = $this->attributeNames;
        $attributeTable = $this->attributeTable;
        return view('pelapor.map_school', compact('ponpes', 'attribute', 'attributeNames', 'attributeTable', 'counts', 'schools'));
