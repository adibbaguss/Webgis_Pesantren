...
class MapFacilityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pengunjung.madin.map_facility', compact('madin', 'facilities', 'attributeNames', 'attributeTable'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $attributeTable = $this->attributeTable;
        $madin = Madin::with('facility_madin')->get();
        return view('pengunjung.madin.map_facility', compact('madin', 'facilities', 'attribute', 'attributeNames', 'attributeTable'));
