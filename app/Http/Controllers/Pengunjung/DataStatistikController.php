...
class DataStatistikController extends Controller
{
    public function index()
    {
        ...
        return view('pengunjung.data_statistik', compact('ponpes', 'ChartDataPonpes', 'ChartDataJumlahPonpes', 'ChartDataStudent', 'ChartDataMadin', 'ChartDataJumlahMadin', 'ChartDataStudentMadin'));
    }
