...
class UpdateProfileController extends Controller
{
    ...
    {
        // Mengambil data madin berdasarkan ID
        $user = User::findOrFail($id);

        // Mengirim data madin ke halaman view_madin.blade.php
        return view('admin_madin.update_profile', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin_madin.profile', ['id' => $id])->with('success', 'Akun Berhasil Diperbaharui');
    }
    ...
    public function update_password(Request $request, $id)
    {
        ...
        return redirect()->route('admin_madin.profile', ['id' => $id])->with('success', 'Password Berhasil Diperbaharui');
    }
