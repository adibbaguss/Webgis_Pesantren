...
class UpdateProfileController extends Controller
{
    ...
    //     return redirect()->route('admin.profile', ['id' => $id])->with('success', 'User updated successfully.');
    // }
    public function update(Request $request, $id)
    {
        $request->validate([
        ...
        return redirect()->route('admin.profile', ['id' => $id])->with('success', 'Akun Berhasil Diperbaharui');
    }
    ...
    public function update_password(Request $request, $id)
    {
        ...
        return redirect()->route('admin.profile', ['id' => $id])->with('success', 'Password Berhasil Diperbaharui');
    }
