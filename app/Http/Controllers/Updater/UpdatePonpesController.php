...
class UpdatePonpesController extends Controller
{
    public function index($id)
    {
        ...
        return view('updater.update_ponpes', compact('ponpes', 'kecamatanOptions'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('updater.ponpes_view', ['id' => $ponpes->user_id])->with('success', 'Pondok Pesantren updated successfully!');
    }
}
