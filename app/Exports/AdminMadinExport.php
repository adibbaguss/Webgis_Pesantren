...
class AdminMadinExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    /**
    ...
    {
        return User::with('madin')
            ->where('user_role', 'admin madin')
            ->get();
    }
    ...
    public function map($account): array
    {
        ...
        return [
            ...
            $account->madin ? $account->madin->name : 'null',
            $account->created_at,
            $account->status,
