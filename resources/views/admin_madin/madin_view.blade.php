...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-between mb-4">
                ...
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('admin_madin.madin_edit', ['id' => $madin->id]) }}"
                                class="dropdown-item">
                        ...
                        <li>
                            <a href="{{ route('admin_madin.madin_edit_etc', ['id' => $madin->id]) }}"
                                class="dropdown-item">
                                <i class="fas fa-edit"></i>
                                Perbaharui Lanjutan
                            </a>
            ...
            {{-- memanggil info madin utama --}}
            @include('layouts.madin.madin_info')
             {{-- end memanggil info madin utama --}}
            {{-- drop dropdown info  --}}
                ...
                <div class="modal-dialog px-0">
                    <div class="modal-content bg-none">
                        ...
                        <div class="modal-body">
                            {{-- <img src="{{ asset('images/madin/default-image.png') }}" alt=""
                                style="width: 100%"> --}}
