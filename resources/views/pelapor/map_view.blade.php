...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="d-flex justify-content-end mt-3">
            <a href="/pelapor/map_view/export_xlsx" class="btn btn-outline-success"><i class="fas fa-file-excel"></i></a>
            <a href="/pelapor/map_view/export_csv" class="btn btn-outline-success ms-2"><i class="fas fa-file-csv"></i></a>
        </div>
    </div>
@endsection
                ...
                <div class="row custom-popup ">
                    ...
                    <div class="col-9 py-0 pe-0 my-auto">
                        <div class="title-map m-0">
                            <a href="{{ route('pelapor.ponpes_view', ['id' => $item->id]) }}">
