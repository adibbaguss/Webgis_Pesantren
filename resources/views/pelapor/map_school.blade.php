...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="form mb-2">
            <form action="{{ route('pelapor.search_schools') }}" method="GET" class="d-flex justify-content-end">
        ...
        @if (!isset($attribute))
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="/pelapor/sekolah_ponpes_export_xlsx" class="btn btn-outline-success"><i
                        class="fas fa-file-excel"></i></a>
                <a href="/pelapor/sekolah_ponpes_export_csv" class="btn btn-outline-success ms-2"><i
            ...
            <div class="row custom-popup ">
                ...
                <div class="col-9 py-0 pe-0 my-auto">
                    <div class="title-map m-0">
                        <a href="{{ route('pelapor.ponpes_view', ['id' => $data->id]) }}">
