...
@section('content')
    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="d-flex align-items-center justify-content-between mb-5">
            ...
            <form class="d-flex me-2 ms-auto " role="search" action="{{ route('pelapor.madin_search') }}" method="GET">
                @csrf
            ...
            @if (count($madin) > 0)
                @foreach ($madin as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-3 mx-0">
                        <a href="{{ route('pelapor.madin.madin_view', ['id' => $item->id]) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <a href="/pelapor/madin_export_xlsx" class="text-deocartion-none btn btn-outline-success p-3">
                        <i class="fas fa-file-excel fs-1"></i>
                        {{ 'Cetak Excel' }}
                    </a>

                    <a href="/pelapor/madin_export_csv" class="text-deocartion-none btn btn-outline-success p-3">
