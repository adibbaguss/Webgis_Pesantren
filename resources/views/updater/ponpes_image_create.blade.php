...
@section('content')
    <div class="container mt-5 pt-5">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-10 bg-white shadow p-md-5">
                <form method="POST" action="{{ route('updater.ponpes_image_create', ['id' => $ponpes->id]) }}" enctype="multipart/form-data" class="mb-2">
                    @csrf
                    <div class="row p-2">
                                ...
                                <div class="px-5 d-grid">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <label class="label custom-file-upload btn btn-outline-secondary h-25 my-auto ms-3"
                                            ...
                                            title="Pilih Gambar untuk Informasi Pesantren">
                                            <input type="file" class="d-none" id="file-input-{{ $i }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-2">
                                            <input id="title-{{ $i }}" type="text"
                                                ...
                                                name="title-{{ $i }}" value="{{ old('title-' . $i) }}" required
                                                autocomplete="title-{{ $i }}" placeholder="Judul Gambar">
                                    ...
                                    <input type="number" name="ponpes_id-{{ $i }}" value="{{ $ponpes->id }}"
                                        hidden>
                                    <input type="text" name="type-{{ $i }}" value="reguler" hidden>
                                    <input type="hidden" id="cropped-image-{{ $i }}"
                                        name="cropped_image-{{ $i }}">
    ...
    @for ($i = 2; $i <= 7; $i++)
        <div class="modal fade imagecrop"id="cropImagemodal-{{ $i }}" data-bs-keyboard="false"
            tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content crop-content border-0 shadow">
                    <div class="modal-header">
