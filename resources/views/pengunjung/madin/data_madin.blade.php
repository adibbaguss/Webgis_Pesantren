...
@section('content')
    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="d-flex align-items-center justify-content-between mb-5">
            ...
            <form class="d-flex me-2 ms-auto " role="search" action="{{ route('pengunjung.madin_search') }}" method="GET">
                @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <a href="/pengunjung/madin_export_xlsx" class="text-deocartion-none btn btn-outline-success p-3">
                        <i class="fas fa-file-excel fs-1"></i>
                        {{ 'Cetak Excel' }}
                    </a>

                    <a href="/pengunjung/madin_export_csv" class="text-deocartion-none btn btn-outline-success p-3">
