                        ...
                        <form method="POST" action="{{ route('update_ponpes.update',  $ponpes->id) }}">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input id="city" type="text" class="form-control" value="{{ $ponpes->city }}" name="city" readonly>
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <select class="form-select" aria-label="Default select example"
                                        name="subdistrict">
                                        <option value="{{ $ponpes->subdistrict }}">{{ $ponpes->subdistrict }}</option>
                                ...
                                <div class="col-12 mb-4">
                                    <label for="" class="small ms-2">{{ 'Status : ('.$ponpes->status.')' }}</label>
                                    <select class="form-select" aria-label="Default select example"
                                        name="status">
