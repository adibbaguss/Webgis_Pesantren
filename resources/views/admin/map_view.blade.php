...
<script>
    ...
    function onMapClick(e) {
        const { lat, lng } = e.latlng; // Separate latitude and longitude variables
    ...
    const overlayLayers = {
        @foreach ($ponpes->groupBy('subdistrict') as $subdistrict => $ponpes)'{{ $subdistrict }}': subdistrictLayers['{{ $subdistrict }}'],
        @endforeach
    };
