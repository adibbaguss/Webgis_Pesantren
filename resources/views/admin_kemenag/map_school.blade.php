...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="form mb-2">
            <form action="{{ route('admin_kemenag.search_schools') }}" method="GET" class="d-flex justify-content-end">
        ...
        @if (!isset($attribute))
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="/admin kemenag/sekolah_ponpes_export_xlsx" class="btn btn-outline-success"><i
                        class="fas fa-file-excel"></i></a>
                <a href="/admin kemenag/sekolah_ponpes_export_csv" class="btn btn-outline-success ms-2"><i
            ...
            <div class="row custom-popup ">
                ...
                <div class="col-9 py-0 pe-0 my-auto">
                    <div class="title-map m-0">
                        <a href="{{ route('admin_kemenag.ponpes_view', ['id' => $data->id]) }}">
