    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        @if (!isset($attribute))
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="/admin kemenag/fasilitas_ponpes_export_xlsx" class="btn btn-outline-success"><i class="fas fa-file-excel"></i></a>
                <a href="/admin kemenag/fasilitas_ponpes_export_csv" class="btn btn-outline-success ms-2"><i class="fas fa-file-csv"></i></a>
            </div>
        @else
            <table class="table table-striped" id="tablefacility" class="display" style="width:100%">
                <thead>
                ...
                <div class="row custom-popup ">
                    ...
                    <div class="col-9 py-0 pe-0 my-auto">
                        <div class="title-map m-0">
                            <a href="{{ route('admin_kemenag.ponpes_view', ['id' => $facility->ponpes->id]) }}">
