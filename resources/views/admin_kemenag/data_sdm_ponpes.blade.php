...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="d-flex mb-3">
            <h2 class="mb-0 text-secondary ">{{ 'Data Sumber Daya Manusia Pesantren Kabupaten Batang Tahun '.$currentYear }}</h2>
        ...
        <table class="table table-bordered table-hover" id="example" class="display" style="width:100%">
            ...
            <tbody>
                ...
                <tr class="align-middle">
                    ...
                    <td class="text-center ">{{ count($data->instructors->where('gender', 'Laki-laki')->where('status', 'active')) }}</td>
                    <td class="text-center ">{{ count($data->instructors->where('gender', 'Perempuan')->where('status', 'active')) }}</td>
                    ...
                    <td class="text-center ">{{ $data->studentCount->sum('male_resident_count') + $data->studentCount->sum('female_resident_count') }}</td>
                    <td class="text-center ">{{ $data->studentCount->sum('male_non_resident_count') + $data->studentCount->sum('female_non_resident_count') }}</td>
                </tr>
            @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <a href="/admin kemenag/sdm_ponpes_export_xlsx" class="text-deocartion-none btn btn-outline-success p-3">
                        <i class="fas fa-file-excel fs-1"></i>
                        {{ 'Cetak Excel' }}
                    </a>

                    <a href="/admin kemenag/sdm_ponpes_export_csv" class="text-deocartion-none btn btn-outline-success p-3">
