    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        @if (!isset($attribute))
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="/admin kemenag/madin/fasilitas/export_xlsx" class="btn btn-outline-success"><i class="fas fa-file-excel"></i></a>
                <a href="/admin kemenag/madin/fasilitas/export_csv" class="btn btn-outline-success ms-2"><i class="fas fa-file-csv"></i></a>
            </div>
        @else
                ...
                <div class="row custom-popup ">
                    ...
                    <div class="col-9 py-0 pe-0 my-auto">
                        <div class="title-map m-0">
                            <a href="{{ route('admin_kemenag.madin.madin_view', ['id' => $facility->madin->id]) }}">
