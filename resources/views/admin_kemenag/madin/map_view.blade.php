...
@section('content')
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="d-flex justify-content-end mt-3">
            <a href="/admin kemenag/map_view/madin/export_xlsx" class="btn btn-outline-success"><i class="fas fa-file-excel"></i></a>
            <a href="/admin kemenag/map_view/madin/export_csv" class="btn btn-outline-success ms-2"><i class="fas fa-file-csv"></i></a>
        </div>
    </div>
@endsection
