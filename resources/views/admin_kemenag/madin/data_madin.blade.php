...
@section('content')
    ...
    <div class="container-fluid mt-5 pt-5">
        ...
        <div class="d-flex align-items-center justify-content-between mb-5">
            <h2 class="mb-0 text-secondary d-md-block d-none">{{ 'Daftar Madrasah Diniyah dan TPQ di Kabupaten Batang' }}</h2>
            <form class="d-flex me-2 ms-auto " role="search" action="{{ route('admin_kemenag.madin_search') }}" method="GET">
                @csrf
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="/admin kemenag/create_madin" class="dropdown-item">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <a href="/admin kemenag/madin_export_xlsx" class="text-deocartion-none btn btn-outline-success p-3">
                        <i class="fas fa-file-excel fs-1"></i>
                        {{ 'Cetak Excel' }}
                    </a>

                    <a href="/admin kemenag/madin_export_csv" class="text-deocartion-none btn btn-outline-success p-3">
