            ...
            <div class="col-12 d-flex justify-content-between mb-4">
                ...
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('admin_pesantren.ponpes_edit', ['id' => $ponpes->id]) }}" class="dropdown-item">
                                <i class="fas fa-edit"></i>
                                Perbaharui Utama
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin_pesantren.ponpes_edit_etc', ['id' => $ponpes->id]) }}" class="dropdown-item">
                                <i class="fas fa-edit"></i>
                                Perbaharui Lanjutan
                            </a>
                        </li>
