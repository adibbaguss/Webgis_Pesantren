            ...
            <div class="col-12 d-flex justify-content-between mb-4">
                ...
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('admin_pesantren.ponpes_edit', ['id' => $ponpes->id]) }}"
                                class="dropdown-item">
                        ...
                        <li>
                            <a href="{{ route('admin_pesantren.ponpes_edit_etc', ['id' => $ponpes->id]) }}"
                                class="dropdown-item">
                                <i class="fas fa-edit"></i>
                                Perbaharui Lanjutan
                            </a>
                                            ...
                                            <table class="table table-bordered border-dark">
                                                ...
                                                <tbody>
                                                    @foreach ($attributeTable as $table)
                                                        <tr>
                                                            <th scope="row" class="align-middle">{{ $attributeNames[$table] ?? '-' }}</th>
