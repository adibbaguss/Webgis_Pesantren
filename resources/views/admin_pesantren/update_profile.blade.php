    ...
    <div class="container-fluid mt-5 pt-5">
        <div class="content_register shadow bg-white mx-auto" style="max-width: 600px">
            <div class="px-2 px-sm-5 pt-4" >
                <form method="POST" action="{{ route('admin_pesantren.profile_update', ['id'=>$user->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    {{-- photo profile --}}
                    ...
                    <div class="row ">
                        ...
                        <div class="col-6 mb-4 me-0 ms-auto d-flex justify-content-end">
                            <a href="{{ route('admin_pesantren.profile', ['id' => $user->id]) }}" class="btn btn-outline-secondary me-1">
                                {{ __('Batal') }}
                            </a>
